<template>
	<page-meta><navigation-bar title="公告详情" title-align="center" background-color="#007AFF" /></page-meta>
	<view class="container">
		<u--text :text="trendObject.noticeTitle" size="20" align="center" bold block customStyle="margin:auto;"></u--text>
		<view style="display:flex;margin-top:20px;justify-content:flex-start;">
		...
		<u-line margin="5px 0 10px 0"></u-line>
		<view class="content"><rich-text :nodes="trendObject.noticeContent"></rich-text></rich-text></view>
		<view><u--text v-if="isShow" text="暂无内容..." customStyle="margin:auto;"></u--text></view>
	</view>
</template>

<script>
import { getNotice } from '@/apis/modules/notice';
